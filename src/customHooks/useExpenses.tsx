...
const useExpenses=()=>{
    ...
    const removeExpense=(id:number)=>{
     return   setExpenses(prevExpenses=>prevExpenses.filter((expense)=>expense.id!==id))
    }
    const getTotalAmount=()=>{
const totalExpenseAmount=expenses.reduce((total,expense)=>total+(expense.amount ?? 0) ,0);
